...
from src.arax_nn.openapi_server.models.knowledge_graph import KnowledgeGraph
from src.arax_nn.openapi_server.models.node import Node
from src.arax_nn.openapi_server.models.edge import Edge
from src.arax_nn.openapi_server.models.attribute import Attribute
from src.arax_nn.openapi_server.models.retrieval_source import RetrievalSource


class NodeSynonymizer:

    def __init__(self):
        self.database_path = f"{file_path}/node_synonymizer_v1.0_KG2.10.2.sqlite"
